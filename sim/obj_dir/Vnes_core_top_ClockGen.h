...
#ifndef VERILATED_VNES_CORE_TOP_CLOCKGEN_H_
#define VERILATED_VNES_CORE_TOP_CLOCKGEN_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vnes_core_top_ClockGen final {
  public:
    ...
    // CONSTRUCTORS
    Vnes_core_top_ClockGen();
    ~Vnes_core_top_ClockGen();
    void ctor(Vnes_core_top__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vnes_core_top_ClockGen);
