...
#ifndef VERILATED_VNES_CORE_TOP_EREG_SAVESTATEV__AZ10_H_
#define VERILATED_VNES_CORE_TOP_EREG_SAVESTATEV__AZ10_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vnes_core_top_eReg_SavestateV__Az10 final {
  public:
    ...
    // CONSTRUCTORS
    Vnes_core_top_eReg_SavestateV__Az10();
    ~Vnes_core_top_eReg_SavestateV__Az10();
    void ctor(Vnes_core_top__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vnes_core_top_eReg_SavestateV__Az10);
