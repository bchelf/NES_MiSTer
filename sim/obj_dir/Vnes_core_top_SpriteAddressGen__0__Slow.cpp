...
VL_ATTR_COLD void Vnes_core_top_SpriteAddressGen___stl_sequent__TOP__nes_core_top__nes_inst__ppu__address_gen__0(Vnes_core_top_SpriteAddressGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_SpriteAddressGen___stl_sequent__TOP__nes_core_top__nes_inst__ppu__address_gen__0\n"); );
...
VL_ATTR_COLD void Vnes_core_top_SpriteAddressGen___stl_sequent__TOP__nes_core_top__nes_inst__ppu__address_gen__1(Vnes_core_top_SpriteAddressGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_SpriteAddressGen___stl_sequent__TOP__nes_core_top__nes_inst__ppu__address_gen__1\n"); );
    Vnes_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vnes_core_top_SpriteAddressGen___stl_sequent__TOP__nes_core_top__nes_inst__ppu__address_gen__2(Vnes_core_top_SpriteAddressGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_SpriteAddressGen___stl_sequent__TOP__nes_core_top__nes_inst__ppu__address_gen__2\n"); );
    Vnes_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vnes_core_top_SpriteAddressGen___ctor_var_reset(Vnes_core_top_SpriteAddressGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_SpriteAddressGen___ctor_var_reset\n"); );
    Vnes_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->__PVT__temp = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 7233838040978344170ull);
    ...
    vlSelf->__PVT__temp_tile = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 16528101220331696479ull);
    vlSelf->__PVT__temp_y = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 4932767861542704422ull);
    ...
    vlSelf->__PVT__load_y = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7337578905487841984ull);
    ...
    vlSelf->__PVT__scanline_y = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 972446324077016510ull);
    vlSelf->__Vdly__count = 0;
    vlSelf->__Vdly__temp_y = 0;
    vlSelf->__Vdly__dummy_sprite = 0;
    vlSelf->__Vdly__temp_tile = 0;
    vlSelf->__Vdly__flip_y = 0;
    vlSelf->__Vdly__flip_x = 0;
}
