...
VL_ATTR_COLD void Vnes_core_top_ClockGen___eval_static__TOP__nes_core_top__nes_inst__clockgen_pause(Vnes_core_top_ClockGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_ClockGen___eval_static__TOP__nes_core_top__nes_inst__clockgen_pause\n"); );
...
VL_ATTR_COLD void Vnes_core_top_ClockGen___eval_initial__TOP__nes_core_top__nes_inst__clockgen_pause(Vnes_core_top_ClockGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_ClockGen___eval_initial__TOP__nes_core_top__nes_inst__clockgen_pause\n"); );
    Vnes_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__SS_CLKGEN = 0ULL;
}

VL_ATTR_COLD void Vnes_core_top_ClockGen___stl_sequent__TOP__nes_core_top__nes_inst__clockgen_pause__0(Vnes_core_top_ClockGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_ClockGen___stl_sequent__TOP__nes_core_top__nes_inst__clockgen_pause__0\n"); );
    Vnes_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__SaveStateBus_Dout = vlSelfRef.__PVT__SS_CLKGEN;
...
VL_ATTR_COLD void Vnes_core_top_ClockGen___stl_sequent__TOP__nes_core_top__nes_inst__clockgen_pause__1(Vnes_core_top_ClockGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_ClockGen___stl_sequent__TOP__nes_core_top__nes_inst__clockgen_pause__1\n"); );
    Vnes_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vnes_core_top_ClockGen___ctor_var_reset(Vnes_core_top_ClockGen* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vnes_core_top_ClockGen___ctor_var_reset\n"); );
    Vnes_core_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
