...
#ifndef VERILATED_VNES_CORE_TOP_EREG_SAVESTATEV__AZ5_H_
#define VERILATED_VNES_CORE_TOP_EREG_SAVESTATEV__AZ5_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vnes_core_top_eReg_SavestateV__Az5 final {
  public:
    ...
    // CONSTRUCTORS
    Vnes_core_top_eReg_SavestateV__Az5();
    ~Vnes_core_top_eReg_SavestateV__Az5();
    void ctor(Vnes_core_top__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vnes_core_top_eReg_SavestateV__Az5);
